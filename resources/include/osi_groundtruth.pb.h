...
inline std::string* GroundTruth::release_proj_string() {
  ...
  return proj_string_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* GroundTruth::release_map_reference() {
  ...
  return map_reference_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
