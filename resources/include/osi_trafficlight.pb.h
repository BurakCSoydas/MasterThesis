...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_osi_5ftrafficlight_2eproto_metadata_getter(int index);
namespace osi3 {
class TrafficLight;
...
class TrafficLight_Classification PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr TrafficLight_Classification(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_osi_5ftrafficlight_2eproto_metadata_getter(kIndexInFileMessages);
  }
