...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_osi_5foccupant_2eproto_metadata_getter(int index);
namespace osi3 {
class Occupant;
...
class Occupant_Classification PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_osi_5foccupant_2eproto_metadata_getter(kIndexInFileMessages);
  }
