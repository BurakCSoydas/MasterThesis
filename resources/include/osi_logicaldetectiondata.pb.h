...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_osi_5flogicaldetectiondata_2eproto_metadata_getter(int index);
namespace osi3 {
...
class LogicalDetectionData PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr LogicalDetectionData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_osi_5flogicaldetectiondata_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class LogicalDetectionDataHeader PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr LogicalDetectionDataHeader(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class LogicalDetection PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr LogicalDetection(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline ::osi3::LogicalDetectionDataHeader* LogicalDetectionData::_internal_mutable_header() {
  ...
  if (header_ == nullptr) {
    auto* p = CreateMaybeMessage<::osi3::LogicalDetectionDataHeader>(GetArena());
    header_ = p;
  }
  return header_;
}
...
inline void LogicalDetectionDataHeader::set_allocated_logical_detection_time(::osi3::Timestamp* logical_detection_time) {
  ...
  if (logical_detection_time) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(logical_detection_time)->GetArena();
    if (message_arena != submessage_arena) {
...
inline void LogicalDetection::set_allocated_velocity_rmse(::osi3::Vector3d* velocity_rmse) {
  ...
  if (velocity_rmse) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(velocity_rmse)->GetArena();
    if (message_arena != submessage_arena) {
