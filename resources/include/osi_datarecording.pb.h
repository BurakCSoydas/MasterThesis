...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_osi_5fdatarecording_2eproto_metadata_getter(int index);
namespace osi3 {
...
class SensorDataSeries PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr SensorDataSeries(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_osi_5fdatarecording_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class SensorDataSeriesList PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr SensorDataSeriesList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
