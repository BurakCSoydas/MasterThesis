...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_osi_5fversion_2eproto_metadata_getter(int index);
namespace osi3 {
...
class InterfaceVersion PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr InterfaceVersion(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_osi_5fversion_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 InterfaceVersion::_internal_version_major() const {
...
inline void InterfaceVersion::_internal_set_version_major(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 InterfaceVersion::_internal_version_minor() const {
...
inline void InterfaceVersion::_internal_set_version_minor(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 InterfaceVersion::_internal_version_patch() const {
...
inline void InterfaceVersion::_internal_set_version_patch(::PROTOBUF_NAMESPACE_ID::uint32 value) {
